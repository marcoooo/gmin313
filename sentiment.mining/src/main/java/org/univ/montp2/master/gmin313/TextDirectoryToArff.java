...
public class TextDirectoryToArff {
  ...
  public static void main(String[] args) {
    ...
    //if (args.length == 1) {
      ...
      try {
	Instances dataset = tdta.createDataset("/home/marcoooo/Documents/GMIN313/Projet-GMIN313/TripAdvisor/Texts/");
        FileWriter fw = null;
        java.io.File theFile = new java.io.File("/home/marcoooo/Documents/GMIN313/Projet-GMIN313/tripadvisor.arff");
